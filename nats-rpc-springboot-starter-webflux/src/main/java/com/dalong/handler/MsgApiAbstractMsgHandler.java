...
import com.dalong.handler.AbstractSubMessageHandler;
...
public abstract class MsgApiAbstractMsgHandler<T extends BaseMessage> extends AbstractSubMessageHandler<T> {
