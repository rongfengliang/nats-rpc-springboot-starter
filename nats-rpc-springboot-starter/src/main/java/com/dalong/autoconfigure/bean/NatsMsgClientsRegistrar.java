...
import com.dalong.client.MsgClient;
...
public class NatsMsgClientsRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        Map<String, Object> attributes = importingClassMetadata
                .getAnnotationAttributes(EnableNatsMsgClients.class.getName());
            ...
            scanner.findCandidateComponents(basePackage).forEach(beanDef -> {
                try {
                    ...
                    BeanDefinitionBuilder builder =
                            BeanDefinitionBuilder.genericBeanDefinition(NatsMsgClientFactoryBean.class);
