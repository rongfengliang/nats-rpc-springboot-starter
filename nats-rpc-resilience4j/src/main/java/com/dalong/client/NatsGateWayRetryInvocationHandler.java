...
public class NatsGateWayRetryInvocationHandler implements InvocationHandler {
    ...
    public NatsGateWayRetryInvocationHandler(Connection nats, ObjectMapper objectMapper, Duration timeout, Retry retry) {
        this.nats = nats;
